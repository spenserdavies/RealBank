  ...
  <div class="accounts container">
    <div class="row mt-5">
      <div class="col-9 mx-auto card bg-light pt-4">
        ...
        <button
          type="button"
          class="btn btn-success w-25 align-self-center my-2 position-relative"
          data-toggle="modal"
          data-target="#newAccount"
          @click="newAccount.accountNumber = null"
        >
          New Account
        </button>
        <button
          ...
          type="button"
          class="btn btn-warning w-25 align-self-end position-absolute transfer-btn"
          data-toggle="modal"
        ...
        <div class="pb-5">
          ...
          >
            <router-link
              :to="{
                name: 'account',
                params: { accountId: account.accountNumber },
              }"
              class="text-dark"
            >
  ...
  methods: {
    ...
    openAccount() {
      if (this.newAccount.accountType != null) {
        this.newAccount.accountNumber = Math.floor(
    ...
    newTransfer() {
      ...
      if (this.accountTo !== this.accountFrom) {
        ...
        this.$store.dispatch("editBalance", this.accountTo);
        let transFrom = {
          accountNumber: this.accountFrom.accountNumber,
